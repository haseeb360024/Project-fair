    ...
    <div className='card shadow p-5'>
       ...
       <Collapse in={open}>
            <div className="row justify-content-center mt-3">
                ...
                <div className='mt-5'>
                    <input style={{height:'50px'}} type="text" className='form-control ' placeholder='Github' />
                </div>
                <div className='mt-4'>
                    <input style={{height:'50px'}} type="text" className='form-control' placeholder='LinkedIn' />
                </div>
